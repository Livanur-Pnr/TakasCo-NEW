...
- [x] N9. Profilden erişilen ayrı "Kargolarım" (gönderdiğiniz kargolar, durumu siz yönetirsiniz) ve "Siparişlerim" (size gönderilen, salt okunur) sayfaları; ortak kargo bileşenleri (`components/shipment.tsx`: `ShippingBox`, `ShippingModal`, `confirmMarkDelivered`) Tekliflerim ile paylaşılır.
